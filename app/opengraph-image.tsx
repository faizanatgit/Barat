...
export const alt = "Baraat Night — Muhammad Zeeshan Azhar Malik";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", overflow: "hidden", background: "#571128", color: "#fff4ca", fontFamily: "serif" }}>
      ...
      <div style={{ width: "100%", padding: "78px 100px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        <div style={{ color: "#e4ba63", fontSize: 28, letterSpacing: 12, textTransform: "uppercase", display: "flex" }}>Baraat Night</div>
